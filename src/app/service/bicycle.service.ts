...
export class BicycleService {
 ...
 galleBicycleList:BikeInterface[]=[
   ...
   {bikeId:'gallebicycle1',bikeName:'lumala',color:'red',condition:'good',quantity:1,img:'',rating:4,ratePerDay:200},
   {bikeId:'gallebicycle2',bikeName:'dunlop',color:'green',condition:'mint condition',quantity:1,img:'',rating:5,ratePerDay:500}  
   
 ];
 
 jaffanaBicycleList:BikeInterface[]=[
 
   {bikeId:'jaffnabicycle1',bikeName:'lumala',color:'red',condition:'good',quantity:10,img:'',rating:4,ratePerDay:200},
   {bikeId:'jaffnabicycle2',bikeName:'dunlop',color:'green',condition:'mint condition',quantity:2,img:'',rating:5,ratePerDay:500}  
